...
namespace Pulumi.AlicloudFcUrl
{
    static class Utilities
    {
        ...
        public static global::Pulumi.InvokeOptions WithDefaults(this global::Pulumi.InvokeOptions? src)
        {
            ...
            dst.PluginDownloadURL = src?.PluginDownloadURL ?? "github://api.github.com/rhysmdnz/pulumi-alicloud-fc-url";
            return dst;
        }
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.AlicloudFcUrl.version.txt");
    ...
    internal sealed class AlicloudFcUrlResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public AlicloudFcUrlResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
