module github.com/rhysmdnz/pulumi-alicloud-fc-url/provider
...
require (
	...
	github.com/rhysmdnz/terraform-provider-alicloud-fc-url/shim v0.0.7
)
...
require (
	...
	github.com/rhysmdnz/terraform-provider-alicloud-fc-url v0.0.7 // indirect
