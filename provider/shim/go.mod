module github.com/rhysmdnz/terraform-provider-alicloud-fc-url/shim
...
require (
	...
	github.com/rhysmdnz/terraform-provider-alicloud-fc-url v0.0.7
)
...
require (
	...
	github.com/alibabacloud-go/fc-20230330/v3 v3.0.3 // indirect
